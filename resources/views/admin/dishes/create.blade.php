        ...
        <div class="row">
            <div class="col">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form class="" action="{{route('admin.dishes.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="position-relative row form-group">
                                <label for="exampleEmail" class="col-sm-2 col-form-label">Nome</label>
                                <div class="col-sm-10">
                                    <input id="name" name="name" placeholder="Inserisci il nome" required value="{{ old('name') }}" type="text" class="form-control">
                                    @error('name')
                                ...
                                <div class="col-sm-10">
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="vegan1">
                                            <input type="radio" class="form-check-input" name="vegan" id="vegan1" value="1" {{ (old('vegan') == 1) ? 'checked' : '' }}>Sì
                                        </label>
                                    </div>
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="vegan2">
                                            <input type="radio" class="form-check-input" name="vegan" id="vegan2" value="0" {{ (old('vegan') == 0) ? 'checked' : '' }}>No
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="col-sm-10">
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="spicy1">
                                            <input type="radio" class="form-check-input" name="spicy" id="spicy" value="1" {{ (old('spicy') == 1) ? 'checked' : '' }}>Sì
                                        </label>
                                    </div>
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="spicy2">
                                            <input type="radio" class="form-check-input" name="spicy" id="spicy2" value="0" {{ (old('spicy') == 0) ? 'checked' : '' }}>No
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="col-sm-10">
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="visible1">
                                            <input type="radio" class="form-check-input" name="visible" id="visible1" value="1" {{ (old('visible') == 1) ? 'checked' : '' }}>Sì
                                        </label>
                                    </div>
                                    <div class="position-relative form-check">
                                        <label class="form-check-label" for="visible2">
                                            <input type="radio" class="form-check-input" name="visible" id="visible2" value="0" {{ (old('visible') == 0) ? 'checked' : '' }}>No
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
