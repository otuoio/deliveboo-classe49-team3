            ...
            <div class="row">
                <div class="col">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <form class="" action="{{route('admin.dishes.update', $dish)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="position-relative row form-group">
                                    <label for="exampleEmail" class="col-sm-2 col-form-label">Nome</label>
                                    <div class="col-sm-10">
                                        <input id="name" name="name" placeholder="with a placeholder" value="{{ old('name', $dish->name) }}" required type="text" class="form-control">
                                        @error('name')
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        @if (!empty($dish->image))
                                            <img style="max-width:40%;" src="{{asset('storage/' . $dish->image)}}" alt="{{$dish->name}}">
                                        @else
                                            <img style="max-width:40%;" class="img-fluid" src="{{ asset('storage/uploads/default/default_dish.jpg')}}" alt="{{ $dish->name }}">
                                        @endif
                                    </div>
                                </div>
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="vegan1">
                                                <input type="radio" class="form-check-input" name="vegan" id="vegan1" value="1" {{ (old('vegan', $dish->vegan) == 1) ? 'checked' : '' }}>Sì
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="vegan2">
                                                <input type="radio" class="form-check-input" name="vegan" id="vegan2" value="0" {{ (old('vegan', $dish->vegan) == 0) ? 'checked' : '' }}>No
                                            </label>
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="spicy1">
                                                <input type="radio" class="form-check-input" name="spicy" id="spicy" value="1" {{ (old('spicy', $dish->spicy) == 1) ? 'checked' : '' }}>Sì
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="spicy2">
                                                <input type="radio" class="form-check-input" name="spicy" id="spicy2" value="0" {{ (old('spicy', $dish->spicy) == 0) ? 'checked' : '' }}>No
                                            </label>
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="visible1">
                                                <input type="radio" class="form-check-input" name="visible" id="visible1" value="1" {{ (old('visible', $dish->visible) == 1) ? 'checked' : '' }}>Sì
                                            </label>
                                        </div>
                                        <div class="position-relative form-check">
                                            <label class="form-check-label" for="visible2">
                                                <input type="radio" class="form-check-input" name="visible" id="visible2" value="0" {{ (old('visible', $dish->visible) == 0) ? 'checked' : '' }}>No
                                            </label>
                                        </div>
                                    </div>
                                </fieldset>
