...
<body>
    ...
    <div class="general-container">
        <div class="container">
            <img class="gif-img" src="https://cdn.dribbble.com/users/338126/screenshots/14926319/media/20b64b8c929f2cad121aae5f0d02e08c.gif" alt="">
            <h3>Ottime notizie! {{ $lead['restaurantName'] }} ha confermato il tuo ordine: arriver&agrave; per le {{ $lead['arrivalTime'] }}</h3>
